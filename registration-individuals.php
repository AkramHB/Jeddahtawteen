...
if(mysqli_query($link, $sql)){
    ...
    include("includeSettings.php");
        ...
        $link = '';
        if($gender == 'male'){
            $sentence = 'يهديكم البرنامج التدريبي لتوطين الوظائف بمحافظة جدة أجمل تحية ونود ابلاغكم بأن المقابلات الشخصية للبرنامج التدريبي سوف تستمر حتى يوم الخميس ٦ ذو القعدة ١٤٣٩ هـ م يوميا من الساعة 10 صباحا الى 2 ظهرا بمقر جامعة جدة في كلية التربية بنين بحي الفيصلية 
          ملاحظة: لا توجد مقابلات يومي الجمعة و السبت<br> 
            موقع المقابلات الشخصية';
            $link = 'https://goo.gl/maps/X7GLCYMTvsz';
        }else {
            $sentence = 'يهديكم البرنامج التدريبي لتوطين الوظائف بمحافظة جدة أجمل تحية ونود ابلاغكم بأن المقابلات الشخصية النسائية للبرنامج التدريبي سوف تستمر يوميا من الساعة 10 صباحا الى 2 ظهرا و لمدة اسبوعين (من الاحد الى الخميس) ابتدأُ من يوم من الأحد 24 شوال 1439 هـ الى الخميس 6 ذو القعدة 1439هـ بمقر جامعة جدة بحي السلامة<br> 
            موقع المقابلات الشخصية ';
            $link = 'https://goo.gl/maps/DiDgWBztZFp';
        }
