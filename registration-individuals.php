    ...
    include("includeSettings.php");
        ...
        if($gender == 'male'){
          ...
          ملاحظة: لا توجد مقابلات يومي الجمعة و السبت<br> 
            ...
            $sentence = 'المقابلات الشخصية النسائية للبرنامج التدريبي سوف تكون من يوم الاحد 9 ذو القعدة ١٤٣٩ هـ الى يوم الخميس ١٣ ذو القعدة ١٤٣٩ هـ يوميا من الساعة 10 صباحا الى 2 ظهرا مقر جامعة جدة بحي السلامة
